...
var StatsModule = {
    ...
    calcGeneralStats: function (sim, form) {
        ...
        for (var i = 0; i < sim.length; i++) {
            ...
            totalWithdrawalsSummed.push(tempSummedWithdrawals.reduce(function (a, b, index, array) {
                return a + b
            }));
        }
    ...
    calcWithdrawalAnalysis: function (sim, form) {
        ...
        if (cycleLength % 3 == 0) { //If perfectly divisible into thirds, each 3rd is the same size. Else, have more years in the first third. Else, have more years in the first third and second third.
            period.thirds = [{
                "start": 0,
                "stop": (cycleLength / 3) - 1
            }, {
                "start": (cycleLength / 3),
                "stop": ((cycleLength / 3)) * 2 - 1
            }, {
                "start": ((cycleLength / 3)) * 2,
                "stop": ((cycleLength / 3)) * 3 - 1
            }, ];
        } else if (cycleLength % 3 == 1) {
            period.thirds = [{
                "start": 0,
                "stop": (Math.ceil(cycleLength / 3) - 1)
            }, {
                "start": (Math.ceil(cycleLength / 3)),
                "stop": (Math.floor(cycleLength / 3) * 2)
            }, {
                "start": (Math.floor(cycleLength / 3) * 2 + 1),
                "stop": (cycleLength - 1)
            }, ];
            ...
            period.thirds = [{
                ...
                "start": (Math.ceil(cycleLength / 3)),
                "stop": (Math.ceil(cycleLength / 3) * 2 - 1)
            }, {
                "start": (Math.ceil(cycleLength / 3) * 2),
                "stop": (cycleLength - 1)
            }, ];
        }
    ...
    calcDipAnalysis: function (sim) {
        ...
        for (var i = 0; i < sim.length; i++) {
            for (var j = 0; j < sim[i].length; j++) {
                ...
                if (sim[i][j].portfolio.infAdjEnd < (initialPortfolio * .4)) {
                    dips.portfolioDip60.push({
                        "year": sim[i][j].year,
                        "cycle": i,
                        "portfolio": sim[i][j].portfolio.infAdjEnd
                    });
                    dips.portfolioDip60MaxDips.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                }
                if (sim[i][j].portfolio.infAdjEnd < (initialPortfolio * .6)) {
                    dips.portfolioDip40.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                    dips.portfolioDip40MaxDips.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                }
                if (sim[i][j].portfolio.infAdjEnd < (initialPortfolio * .8)) {
                    dips.portfolioDip20.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                    dips.portfolioDip20MaxDips.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                }
                if (sim[i][j].portfolio.infAdjEnd < (initialPortfolio * .9)) {
                    dips.portfolioDip10.push({
                        "year": sim[i][j].year,
                        "cycle": i,
                        "portfolio": sim[i][j].portfolio.infAdjEnd
                    });
                    dips.portfolioDip10MaxDips.push({
                        "year": sim[i][j].year,
                        "cycle": i,
                        "portfolio": sim[i][j].portfolio.infAdjEnd
                    });
                ...
                if (sim[i][j].infAdjSpending < (initialWithdrawal * .4)) {
                    dips.withdrawalDip60.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                    dips.withdrawalDip60MaxDips.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                }
                if (sim[i][j].infAdjSpending < (initialWithdrawal * .6)) {
                    dips.withdrawalDip40.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                    dips.withdrawalDip40MaxDips.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                }
                if (sim[i][j].infAdjSpending < (initialWithdrawal * .8)) {
                    dips.withdrawalDip20.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                    dips.withdrawalDip20MaxDips.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                }
                if (sim[i][j].infAdjSpending < (initialWithdrawal * .9)) {
                    dips.withdrawalDip10.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                    dips.withdrawalDip10MaxDips.push({
                        "year": sim[i][j].year,
                        "cycle": i
                    });
                }
        ...
        function dipsPerCycle(dipsArray) {
            ...
            for (var i = 0; i < dipsArray.length; i++) {
                ...
                if (trigger == false) {
                    cyclesWithDips.push({
                        "cycle": dipsArray[i].cycle,
                        "year": dipsArray[i].year
                    });
                }
            }
        ...
        function lowestIndividualDips(sim) {
            ...
            for (var i = 0; i < sim.length; i++) {
                for (var j = 0; j < sim[i].length; j++) {
                    if (lowestPortfolioDips.length < 5) {
                        lowestPortfolioDips.push({
                            "portfolio": sim[i][j].portfolio.infAdjEnd,
                            "cycleStart": (sim[i][j].year - j),
                            "dipYear": sim[i][j].year
                        });
                    } else {
                    ...
                    if (lowestWithdrawalDips.length < 5) {
                        lowestWithdrawalDips.push({
                            "withdrawal": sim[i][j].infAdjSpending,
                            "cycleStart": (sim[i][j].year - j),
                            "dipYear": sim[i][j].year
                        });
                    } else {
            ...
            return {
                "portfolioDips": lowestPortfolioDips,
                "withdrawalDips": lowestWithdrawalDips
            };
        }
